define([
  ...
  utilities.calcBar = function(bpm){
  ...
  utilities.calcSpeed = function(bar){
  ...
  utilities.angPos_rad = function(t, bar, tempoAdjustment, multiplier){
  ...
  utilities.angPos = function(t, bar, tempoAdjustment, multiplier){
    // OUTPUT: angular position in radian, assuming 0 corresponds to top of circle
    // INPUT:
      // t: in seconds
      // bar: seconds for 1 bar
  ...
  utilities.xPos = function(angPos, r){
  ...
  utilities.xPos_rad = function(angPos_rad, r){
    // OUTPUT: x-position for given angle in degree
    // INPUT: 
      // angPos: angular position in degree
      // r: radius (default: 1)
  ...
  utilities.yPos = function(angPos, r){
  ...
  utilities.yPos_rad = function(angPos_rad, r){
    // OUTPUT: y-position for given angle in degree
    // INPUT: 
      // angPos: angular position in degree
      // r: radius (default: 1)
